...
class StudentOwnerAccessGroup extends BaseObjectAccessGroup {
  constructor(studentId: string) {
    super(ObjectAccessGroupType.STUDENT_OWNER, studentId);
  }
...
function createObjectAccessGroup(
  ...
  switch (group.type) {
    case ObjectAccessGroupType.STUDENT_OWNER:
      return new StudentOwnerAccessGroup(group.id);
