...
const achievementsCatalog: Achievement[] = [
  // Profile completion achievements
  {
    ...
    type: 'completion',
    title: 'First Steps',
    description: 'You completed your basic profile information',
    icon: 'check',
    points: 10,
  },
  {
    ...
    description: 'You added your educational history',
    icon: 'check',
    points: 15,
  },
  {
    ...
    description: 'You uploaded all your important documents',
    icon: 'check',
    points: 20,
  },
  {
  ...
  },
  {
    ...
    description: 'You submitted applications to 3 different universities',
    icon: 'star',
    points: 40,
  },
